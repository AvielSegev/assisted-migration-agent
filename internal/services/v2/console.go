...
func NewConsoleService(cfg config.Agent, client *console.Client, mgr *ServiceManager, st *store.Store2) (*Console, error) {
	...
	c := newConsoleService(cfg, client, mgr, st, defaultStatus)
